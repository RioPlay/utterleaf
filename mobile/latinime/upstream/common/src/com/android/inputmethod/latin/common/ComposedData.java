...
// Utterleaf modification: owned snapshots carry request validity through native admission.
...
public class ComposedData {
    ...
    /** Standalone dictionary tools have no editor; IME snapshots override this with identity. */

...
// Utterleaf modification: transient decoder sessions can retire without closing dictionary data.
...
public abstract class Dictionary {
    ...
    /** Retire transient decoder state; never remove dictionary entries or files. */

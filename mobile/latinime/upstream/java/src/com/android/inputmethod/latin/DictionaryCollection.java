...
// Utterleaf modification: forward transient session retirement to owned dictionaries.
...
public final class DictionaryCollection extends Dictionary {
    ...
    public void clearSession() {
        for (final Dictionary dictionary : mDictionaries) dictionary.clearSession();
    }

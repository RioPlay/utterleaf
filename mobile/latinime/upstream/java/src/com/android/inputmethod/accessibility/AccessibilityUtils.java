...
// Utterleaf modifications: use the public platform announcement event constant and
// release cached editor words when the input session retires.
...
public final class AccessibilityUtils {
     ...
     */
    /** Drops references to editor words without querying or modifying an editor. */

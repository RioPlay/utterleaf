...
// Utterleaf modification: expose local transient session retirement independently of data lifetime.
...
public interface DictionaryFacilitator {
    ...
    /** Retire transient decoder state without unloading or changing dictionaries. */
    void clearSession();
    ...
    @Nonnull SuggestionResults getSuggestionResults(final ComposedData composedData,
            final NgramContext ngramContext, @Nonnull final ProximityInfo proximityInfo,

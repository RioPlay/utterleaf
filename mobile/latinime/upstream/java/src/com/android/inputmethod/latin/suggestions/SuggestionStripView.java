...
// Utterleaf modification: retire reachable editor-text and suggestion UI caches.
...
public final class SuggestionStripView extends RelativeLayout implements OnClickListener,
    ...
    /**
     * Drops reachable editor-text caches. This is not secure memory zeroization.
     * Call on the UI thread at session retirement, not for each suggestion update.
     */
    public void clearEditorSession() {
        clear();
        mSuggestedWords = SuggestedWords.getEmptyInstance();
        mStartIndexOfMoreSuggestions = 0;
        for (final TextView wordView : mWordViews) {
            wordView.setText(null);
            wordView.setContentDescription(null);
            wordView.setTag(null);
        }
        for (final TextView debugView : mDebugInfoViews) {
            debugView.setText(null);
            debugView.setContentDescription(null);
            debugView.setTag(null);
        }
        mMoreSuggestionsBuilder.clearEditorSession();
        mMoreSuggestionsView.clearEditorSession();
    }

...
// Utterleaf modification: dark default; explicit theme choices remain honored.
...
public final class KeyboardTheme implements Comparable<KeyboardTheme> {
    ...
    static final KeyboardTheme[] KEYBOARD_THEMES = {
        ...
        new KeyboardTheme(THEME_ID_LXX_LIGHT, "LXXLight", R.style.KeyboardTheme_LXX_Light,
                // Available as an explicit light-theme choice.
                VERSION_CODES.BASE),
        new KeyboardTheme(THEME_ID_LXX_DARK, "LXXDark", R.style.KeyboardTheme_LXX_Dark,
                // Utterleaf default for supported Android versions.
    ...
    // Shared schema key for the Utterleaf preferences adapter and regression tests.
    public static String getPreferenceKey(final int sdkVersion) {
        if (sdkVersion <= VERSION_CODES.KITKAT) {

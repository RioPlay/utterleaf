...
public final class MoreSuggestions extends Keyboard {
    ...
    // No editor data or native proximity allocation in this terminal placeholder.
    static MoreSuggestions newEmptyKeyboard() {
        final MoreSuggestionsParam params = new MoreSuggestionsParam();
        params.GRID_WIDTH = 1;
        params.GRID_HEIGHT = 1;
        return new MoreSuggestions(params, SuggestedWords.getEmptyInstance());
    }
    ...
    public static final class Builder extends KeyboardBuilder<MoreSuggestionsParam> {
        ...
        /** Releases cached suggestions and key labels at an editor-session boundary. */
        public void clearEditorSession() {
            mSuggestedWords = SuggestedWords.getEmptyInstance();
            mFromIndex = mToIndex = 0;
            mParams.mSortedKeys.clear();
            mParams.mShiftKeys.clear();
            mParams.mAltCodeKeysWhileTyping.clear();
        }

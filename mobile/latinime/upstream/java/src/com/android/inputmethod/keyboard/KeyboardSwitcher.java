...
// Utterleaf modification: detect stale geometry when local comfort preferences change.
...
public final class KeyboardSwitcher implements KeyboardState.SwitchActions {
    ...
    public boolean needsKeyboardGeometryUpdate(final SettingsValues settingsValues) {
        final Keyboard keyboard = getKeyboard();
        return keyboard == null
                || keyboard.mId.mHeight != ResourceUtils.getKeyboardHeight(
                        mThemeContext.getResources(), settingsValues)
                || keyboard.mId.mWidth != ResourceUtils.getDefaultKeyboardWidth(mThemeContext);
    }

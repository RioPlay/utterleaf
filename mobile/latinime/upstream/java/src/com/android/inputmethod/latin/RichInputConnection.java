...
// Utterleaf modification: local-only teardown releases connection and editor-text cache references.
...
public final class RichInputConnection implements PrivateCommandPerformer {
    ...
    /** Drop local editor references and caches without querying or modifying any editor. */
    public void clearLocalState() {
        mIC = null;
        mCommittedTextBeforeComposingText = new StringBuilder();
        mComposingText = new StringBuilder();
        mTempObjectForCommitText = new SpannableStringBuilder();

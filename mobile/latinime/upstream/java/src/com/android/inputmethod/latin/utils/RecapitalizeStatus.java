...
// Utterleaf modification: full lifecycle reset releases retained recapitalization text.
...
public class RecapitalizeStatus {
    ...
    /** Release editor text and disable recapitalization at an editor lifetime boundary. */
    public void reset() {
        mIsStarted = false;
        mIsEnabled = false;
        mStringBefore = "";
        mStringAfter = "";
        mCursorStartBefore = -1;
        mCursorStartAfter = -1;
        mCursorEndAfter = -1;
        mRotationStyleCurrentIndex = 0;
        mSkipOriginalMixedCaseMode = false;
        mSortedSeparators = EMPTY_STORTED_SEPARATORS;

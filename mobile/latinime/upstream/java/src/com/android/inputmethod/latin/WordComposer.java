...
// Utterleaf modification: full reset detaches pointer arrays; gesture text updates preserve them.
...
public final class WordComposer {
    ...
    /**
     * Clear the composition and detach all touch coordinates registered so far.
     */
    public void reset() {
        resetComposingWordPreservingPointers();
        // InputPointers may share arrays with a gesture owner or a resumed last word.
        // reset allocates new arrays: never wipe an array another owner still uses.
        mInputPointers.reset();
    }

    // A completed gesture replaces the textual word while retaining its path and caps mode.
    // All other reset callers must detach old coordinates through reset().
    private void resetComposingWordPreservingPointers() {

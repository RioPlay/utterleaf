...
// Utterleaf modification: support an independent application ID.
...
public final class SubtypeLocaleUtils {
    ...
    private static void initLocked(final Context context) {
        ...
        sResources = res;
        // Utterleaf: resource package identity can differ from the Java namespace.
        final String resourcePackageName = res.getResourcePackageName(R.string.subtype_en_US);

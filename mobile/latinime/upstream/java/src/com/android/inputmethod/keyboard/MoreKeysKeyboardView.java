...
public class MoreKeysKeyboardView extends KeyboardView implements MoreKeysPanel {
    ...
    /** Used by suggestion panes when the owning editor session ends. */
    protected void clearKeyInteractionState() {
        mCurrentKey = null;
        mActivePointerId = -1;
        // The delegate also retains hover keys and virtual-node descriptions.

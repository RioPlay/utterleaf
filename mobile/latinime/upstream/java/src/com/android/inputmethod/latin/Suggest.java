...
// Utterleaf modification: decode only captured composer inputs and correction threshold.
...
public final class Suggest {
    ...
    private static ArrayList<SuggestedWordInfo> getTransformedSuggestedWordInfoList(
            final SuggestionComposerSnapshot wordComposer, final SuggestionResults results,

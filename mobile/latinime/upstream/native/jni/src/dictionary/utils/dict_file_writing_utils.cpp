...
// Utterleaf modification: checked durable file output and create-only transaction admission.
...
/* static */ bool DictFileWritingUtils::createEmptyV4DictFile(const char *const dirPath,
    ...
    std::shared_ptr<StorageGeneration> generation;
    StorageTransaction transaction(dirPath, &generation);
...
/* static */ bool DictFileWritingUtils::flushBufferToFile(const char *const filePath,
    ...
    return StorageTransaction::finishFile(file);
}

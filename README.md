...
| --- | --- |
| <img src="docs/assets/screenshots/dictation-dark.png" width="460" alt="Utterleaf desktop dictation settings on Windows" /> | <img src="docs/assets/screenshots/android-voice-edit-alpha11.png" width="230" alt="Utterleaf Android voice transcript editor and keyboard with sample text" /> |
...
| Android ARM64 preview | [Signed Android alpha13 APK](https://github.com/RioPlay/utterleaf/releases/download/android-v0.1.0-alpha13/Utterleaf-Android-0.1.0-alpha13.apk) | [Setup & current limits](docs/mobile.md) |

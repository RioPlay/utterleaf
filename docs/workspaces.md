...
| `release/desktop-0.4.6rc2` | Windows x64 CPU prerelease with runtime notice corrections | Complete canonical build, exact artifact review and preview publication |
...
| `release/android-alpha14` | Original keyboard snapshot candidate, draft PR #25 | Complete exact-SHA CI and the persistent-key signing/release gates |

...
Merged through PR #52 (80bec1b); exact-source CI 35290270474 passed 173 instrumentation tests. The fixes shipped in signed alpha18; see the [completed release record](android-alpha18-snapshot.md).
...
| Release candidate | Exact-revision CI, signed APK continuity, install/upgrade with model/preferences retained, reviewed screenshots and accurate known limits | Signed alpha18 published; exact-candidate CI and signing/update checks are in [the completed release record](android-alpha18-snapshot.md) |

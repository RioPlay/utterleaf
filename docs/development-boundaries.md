...
| Versions/tags | Python version; `v*` release tags | Android versionCode/versionName; `android-v*` tags | Reserve `ios-v*`; no release today |
| Distribution | Desktop archives; stable latest release | Separate Android prerelease and signed APK | Separate Apple distribution |
